...
public class AnimatedLineChart extends Application {
    ...
    private void init(Stage primaryStage) {
        ...
        // Set Name for Series
        series1.setName(merge.getName());
        series2.setName(quick.getName());
    ...
    private class AddToQueue implements Runnable {
        public void run() {
            try {
                ...
                dataQ1.add(execute_alg(merge));
                dataQ2.add(execute_alg(quick));
//                dataQ3.add(Math.random());
        ...
        private double execute_alg(Sort a) {
            List<Integer> l = generator(size, Integer.MAX_VALUE);
            size += 5000;
            a.setUp(l);
